...
export default function Navbar() {
    ...
    return (
        <header className={`w-full max-w-[1920px] mx-auto sticky top-0 z-50 transition-opacity duration-300 rounded-b`} style={{ opacity, backgroundColor: theme === 'dark' ? 'rgba(31, 41, 55, 0.8)' : 'rgba(255, 255, 255, 0.8)' }}>
